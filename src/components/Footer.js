...
const Footer = () => {
    ...
    <div className='text-center lg:flex lg:justify-evenly lg:p-16'>
      ...
      <div className='py-5'>
        <ul>
          <li><a href="#" className='flex items-center justify-center text-lg transition-transform transform hover:scale-110'><FaFacebookSquare size={20} className='m-2'/>Facebook</a></li>
          <li><a href="#" className='flex items-center justify-center text-lg transition-transform transform hover:scale-110'><FaInstagram size={20} className='m-2'/>Instagram</a></li>
          <li><a href="#" className='flex items-center justify-center text-lg transition-transform transform hover:scale-110'><FaXTwitter size={20} className='m-2'/>X (Twitter)</a></li>
        </ul>
      </div>
      <div>
        <ul className='py-5'>
